...
import CreateAccountForm from "../form/createAccountFrom";
import LoginAccountForm from "../form/loginAccountFrom";
        ...
        <ul className={"flex p-0 my-12"}>
          ...
          >
            ...
            <div className={"flex items-center gap-1"}>
              <span className={"font-mono font-bold text-xl"}>Mirabbosbek</span>
              <LockKeyhole />
            </div>
          </li>
